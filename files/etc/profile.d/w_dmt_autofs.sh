...
if id -nG "$USER" | grep -qw "g-share-damantec"; then
  ...
  echo "damantec_win -fstype=cifs,rw,noperm,vers=3.0,credentials=~/.smbcredentials ://dmtsdc001.ad.damantec.org/DAMANTEC" >> ~/.auto.damantec
...
if id -nG "$USER" | grep -qw "g-share-knowledge"; then
  ...
  echo "knowledge_win -fstype=cifs,rw,noperm,vers=3.0,credentials=~/.smbcredentials ://dmtsdc001.ad.damantec.org/Knowledge" >> ~/.auto.damantec
fi
...
if id -nG "$USER" | grep -qw "g-share-development"; then
  ...
  echo "development_win -fstype=cifs,rw,noperm,vers=3.0,credentials=~/.smbcredentials ://dmtsdc001.ad.damantec.org/Development" >> ~/.auto.damantec
fi
...
if id -nG "$USER" | grep -qw "g-share-multimedia"; then
  ...
  echo "multimedia_win -fstype=cifs,rw,noperm,vers=3.0,credentials=~/.smbcredentials ://dmtsdc001.ad.damantec.org/Multimedia" >> ~/.auto.damantec
fi
...
if id -nG "$USER" | grep -qw "g-share-software"; then
  ...
  echo "software_win -fstype=cifs,rw,noperm,vers=3.0,credentials=~/.smbcredentials ://dmtsdc001.ad.damantec.org/Software" >> ~/.auto.damantec
fi
...
if id -nG "$USER" | grep -qw "g-share-temporaer"; then
  ...
  echo "temporaer_win -fstype=cifs,rw,noperm,vers=3.0,credentials=~/.smbcredentials ://dmtsdc001.ad.damantec.org/Temporaer" >> ~/.auto.damantec
fi
