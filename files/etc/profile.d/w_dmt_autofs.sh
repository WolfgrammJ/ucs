...
if id -nG "$USER" | grep -qw "g-share-damantec"; then
  ...
  echo "damantec_win -fstype=cifs,rw,noperm,vers=3.0,credentials=~/.smbcredentials ://10.10.0.1/DAMANTEC" >> ~/.auto.damantec
...
if id -nG "$USER" | grep -qw "g-share-knowledge"; then
  ...
  echo "knowledge_win -fstype=cifs,rw,noperm,vers=3.0,credentials=~/.smbcredentials ://10.10.0.1/Knowledge" >> ~/.auto.damantec
fi
...
if id -nG "$USER" | grep -qw "g-share-development"; then
  ...
  echo "development_win -fstype=cifs,rw,noperm,vers=3.0,credentials=~/.smbcredentials ://10.10.0.1/Development" >> ~/.auto.damantec
fi
...
if id -nG "$USER" | grep -qw "g-share-multimedia"; then
  ...
  echo "multimedia_win -fstype=cifs,rw,noperm,vers=3.0,credentials=~/.smbcredentials ://10.10.0.1/Multimedia" >> ~/.auto.damantec
fi
...
if id -nG "$USER" | grep -qw "g-share-software"; then
  ...
  echo "software_win -fstype=cifs,rw,noperm,vers=3.0,credentials=~/.smbcredentials ://10.10.0.1/Software" >> ~/.auto.damantec
fi
...
if id -nG "$USER" | grep -qw "g-share-temporaer"; then
  ...
  echo "temporaer_win -fstype=cifs,rw,noperm,vers=3.0,credentials=~/.smbcredentials ://10.10.0.1/Temporaer" >> ~/.auto.damantec
fi
